...
export const catppuccinTheme: Theme = {
	...
	properties: {
		...
		'--control-box-border': macchiato.overlay0,
		'--control-border': macchiato.surface2,
		...
		'--input': macchiato.surface0,
		'--input-border': macchiato.surface2,
		'--on-input': macchiato.text,
		'--on-input-hover': macchiato.rosewater,
