...
@Component({
	selector: 'app-series-loader-page-by-type',
	templateUrl: './series-loader-by-type.component.html',
	styleUrls: ['./series-loader-by-type.component.scss']
})
export class SeriesLoaderByTypeComponent implements OnInit, OnDestroy {
	albumType: AlbumType;
