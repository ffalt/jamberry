...
import { MUSICBRAINZ_VARIOUS_ARTISTS_ID } from '@utils/jam-lists';
import { JamAlbumObject, JamArtistObject, JamFolderObject, JamGenreObject, type JamLibraryObject, JamPlaylistObject, JamPodcastObject, JamSeriesObject } from './objects';
...
export abstract class JamObjsLoader {
	...
	abstract search(query: JamObjsLoaderSearchQuery, skip?: number, take?: number): Promise<{
		list: Jam.Page;
		items: Array<JamLibraryObject>;
	}>;

	abstract list(listQuery: { listType: ListType; albumType?: AlbumType }, skip?: number, take?: number): Promise<{
		list: Jam.Page;
		items: Array<JamLibraryObject>;
	}>;
...
export class AlbumsLoader extends JamObjsLoader {
	...
	async search(query: JamObjsLoaderSearchQuery, skip?: number, take?: number): Promise<{
		list: Jam.AlbumPage;
		items: Array<JamLibraryObject>;
	}> {
	...
	async list(listQuery: { listType: ListType; albumType?: AlbumType }, skip?: number, take?: number): Promise<{
		list: Jam.AlbumPage;
		items: Array<JamLibraryObject>;
	}> {
...
export class GenresLoader extends JamObjsLoader {
	...
	async list(listQuery: { listType: ListType }, skip?: number, take?: number): Promise<{
		list: Jam.GenrePage;
		items: Array<JamLibraryObject>;
	}> {
