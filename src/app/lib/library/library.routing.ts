...
export const libaryRoutes: Routes = [
	...
	},
	{
		...
		children: [
			...
			{
				path: 'discogs',
				loadComponent: async () => import('./components/album-discogs/album-discogs.component').then(m => m.AlbumDiscogsComponent),
				canActivate: [AuthCanActivateGuard],
				data: { name: 'Discogs' }
			},
			{ path: '**', redirectTo: '' }
	...
	},
	{
		...
		children: [
			...
			{
				path: 'discogs',
				loadComponent: async () => import('./components/folder-discogs/folder-discogs.component').then(m => m.FolderDiscogsComponent),
				canActivate: [AuthCanActivateGuard],
				data: { name: 'Discogs' }
			},
			{ path: '**', redirectTo: '' }
