...
@Component({
	...
	imports: [AgoPipe, BackgroundTextListComponent, CommonModule, DurationPipe, IconFavComponent, IconCheckmarkComponent, IconClockComponent, IconHashComponent, IconHeadphonesComponent, IconHeartEmptyComponent, IconStopwatchComponent]
})
