import { type AfterContentInit, Component, inject, input, type OnChanges, type SimpleChange } from '@angular/core';
...
export class CoverartImageComponent implements OnChanges, AfterContentInit {
	...
	ngOnChanges(changes: { [key: string]: SimpleChange | undefined }): void {
