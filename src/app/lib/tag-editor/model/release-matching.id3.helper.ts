...
function fillCommon(
	...
	if (
		...
		track.recording.aliases.length > 0 &&
		track.recording.aliases[0].sortName &&
...
function addExistingImages(builder: ID3V24TagBuilder, oldImages?: Array<Jam.MediaTagRawFramePic>): void {
	if (!oldImages) return;
