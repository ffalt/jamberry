...
export interface RawTagEditCell<T> {
	parent: RawTagEditRow;
	track: Jam.Track;
	column: RawTagEditColumn;
	frames: Array<RawTagEditFrame<T>>;
	changed: boolean;
}
...
export interface RawTagEditColumn {
	...
	getAutoCompleteList?(cell?: RawTagEditCell<any>): Array<string>;
}

export interface RawTagEditRow {
	track: Jam.Track;
	tag?: Jam.MediaTagRaw;
	cells: Array<RawTagEditCell<any>>;
	editing: boolean;
	changed: boolean;
	saving: boolean;
}

export interface RawTagEditFrame<T> {
	id: string;
	value: T;
	subframes?: Array<RawTagEditFrame<any>>;
}
...
export const DefaultFrameColumns: Array<{ id: string; subid?: string; width: number; force?: boolean }> = [
	...
	{ id: 'TXXX', subid: 'DISCOGS_ARTIST_ID', width: 40 },
	{ id: 'TXXX', subid: 'DISCOGS_RELEASE_ID', width: 40 },
	{ id: 'TXXX', subid: 'DISCOGS_MASTER_ID', width: 40 },
	{ id: 'TXXX', subid: 'DISCOGS_LABEL_ID', width: 40 },
	{ id: 'TSSE', width: 80 },
	{ id: 'TFLT', width: 80 },
	{ id: 'TSST', width: 80 },
