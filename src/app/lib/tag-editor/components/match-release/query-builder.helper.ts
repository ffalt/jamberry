...
export class QueryBuilderHelper {
	...
	private static addMBQuery(
		...
		fields: JamParameters.MusicBrainzSearchParameters,
		match: Matching,
		...
		for (const key of keys) {
			if (key === 'type' || key === 'tracks') continue;
			const v = fields[key];
