...
export class InlineEditComponent implements ControlValueAccessor {
	...
	onChange?: (_: any) => Record<string, unknown>; // Trascend the onChange event
	onTouched?: (_: any) => Record<string, unknown>; // Trascend the onChange event
	private readonly inlineEditControl = viewChild<ElementRef<HTMLInputElement>>('inlineEditControl'); // input DOM element
